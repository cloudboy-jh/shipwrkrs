            ...
            <div :class="['prompt-block', { 'is-expanded': isExpanded }]">
                <div class="prompt-inner">
                    ...
                    <button
                        ...
                        class="expand-btn"
                        type="button"
                        aria-label="Expand description box"
                        @click="expandPrompt"
                    >
                        <Maximize2 :size="15" />
                    </button>
...
import { Maximize2, ScrollText, SquareChevronRight } from "lucide-vue-next";
...
const showExpandControl = computed(() => description.value.length >= 30);
...
function handleDescriptionInput() {
    ...
    if (description.value.length < 30) isExpanded.value = false;
}
