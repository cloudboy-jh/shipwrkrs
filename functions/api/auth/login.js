import { badRequest, createSessionToken, ensureUser, getDefaultAccountId, isMockMode, setCookie } from '../_lib';
export const onRequestGet = async ({ env }) => {
    ...
    if (!hasOauth) {
        ...
        if (!accountId)
            return badRequest('CF_DEPLOY_ACCOUNT_ID missing', 500);
